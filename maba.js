const mySecret = process.env['token']//laxwary xwara wa tokin dany hech das kare ama na maka
...
let owners = '854305317549506592'//ايدي الي هيتحول 
let owner;
const
  updateAdmins = () => {
  owner = db.get("admins")
  owners = '854305317549506592'
  owner.unshift('854305317549506592')//id xot
}
updateAdmins()
//let sv = '942205780839510' حط ايدي سيرفر يخرج منو بوت
...
client.on('guildCreate', guild => {
  ...
  let textList = ["MABA" , `${prefix}help` , "BY MABA KALARI"] 
